...
Retention that can be specified for TIME-WINDOWS (i.e. time check) or REDUNDANCY (i.e. number of copies).

# Parameters
Those listed below are the parameters that must be entered in order for the script to work.
...
|MDBCK_DAILYRETENTION_TYPE | mixed | N/A | Identifies whether to enable or disable the retention check. See previous description. via string. See previous description|
